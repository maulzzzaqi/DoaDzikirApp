package com.mawl.doadzikirapp.model
...
object DataDoaDzikir {
    ...
    fun ListDzikir() : List<DoaDzikirItem> {
        ...
        for (i in descDzikir.indices) {
            val dzikir = DoaDzikirItem(descDzikir[1], arabicDzikir[1], translateDzikir[1])
    ...
    fun ListDzikirPagi() : List<DoaDzikirItem> {
        ...
        for (i in descDzikirPagi.indices) {
            val data = DoaDzikirItem(
                descDzikirPagi[i],
                arabicDzikirPagi[i],
